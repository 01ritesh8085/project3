...
public class HTMLUtility {
	...
	public static String getLiss(String name, String selectedVal, Map<Integer, String> map) {
	...
	public static String getListt(String name, String selectedVal, Map<Integer, String> map) {
