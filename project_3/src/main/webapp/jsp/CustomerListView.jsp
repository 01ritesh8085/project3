...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.CUSTOMER_LIST_CTL%>"
			...
			<%
				List clist = (List) request.getAttribute("clientName");
			%>

			<%
				Map map = (Map) request.getAttribute("importance");
			%>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2"><%=HTMLUtility.getPreload("Importance", String.valueOf(dto.getImportance()), map)%></div>
				&emsp;
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: grey">
							...
							<th width="20%" class="text">ContactNumber</th>
							<th width="10%" class="text">Importance</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=map.get(dto.getImportance())%></td>
